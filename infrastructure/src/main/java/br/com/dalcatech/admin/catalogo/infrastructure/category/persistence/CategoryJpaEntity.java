...
public class CategoryJpaEntity
    ...
    @Column(name = "created_at", nullable = false, columnDefinition = "DATETIME(6)") //6 eh ate microsegundos, precisao
    ...
    public static CategoryJpaEntity from(final Category aCategory)
        {
        //factory methods, vamos converter uma categoria agregado em uma categoryJPA
