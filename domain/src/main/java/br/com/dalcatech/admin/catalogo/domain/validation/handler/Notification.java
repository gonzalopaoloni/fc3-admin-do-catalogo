package br.com.dalcatech.admin.catalogo.domain.validation.handler;
...
public class Notification implements ValidationHandler
    {
    //este e o padrao notification, para retornar todos os erros de validacao juntos de uma vez
